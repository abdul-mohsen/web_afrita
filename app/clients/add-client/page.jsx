  ...
  return (
    <div>
        <div className='breadcrumb w-full text-xl flex flex-row gap-5 justify-start items-center mb-6'>
            ...
            <h2 className='text-app-gray'>عميل جديد </h2>
        </div>
        <div className="add-form w-full bg-white p-8 rounded-xl">
            <form class="max-w-[600px]">
                <h3 className='text-primary text-2xl '> اسم العميل</h3>
                <div class="space-y-12">
                    <div class="pb-12">
                            ...
                            <div class="sm:col-span-4">
                                <label
                                    for="product-name"
                                    class="block text-lg font-medium leading-6 text-gray-900">  عنوان العميل</label>
                                <div class="mt-2">
                                    <input
                                        type="address"
                                        name="product-name"
                            ...
                            <div class="sm:col-span-4">
                                <label
                                    for="product-name"
                                    class="block text-lg font-medium leading-6 text-gray-900"> رقم العميل</label>
                                <div class="mt-2">
                                    <input
                                        type="text"
                                        name="product-name"
