...
const Aside = () => {
   ...
   return (
    <aside className="z-20 md:w-[18rem] overflow-y-auto bg-white flex-shrink-0">
        <div className="md:py-4 text-gray-500">
            <a className="px-2 md:px-6 flex justify-center items-center text-lg font-bold w-full max-md:h-[100px]" href="./" >
                <Image src={LogoImage} alt="Afrita Logo" className='max-md:hidden w-3/5' />
                <Image src={MobileLogo} alt="Afrita Logo" className='md:hidden  w-3/5' />
            </a>
            <NavLinks />
            <div className="md:px-6 my-6">
                <button className="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-primary-600 border border-transparent rounded-lg bg-primary hover:bg-primary/75 focus:outline-none focus:shadow-outline-primary">
                    <span className='md:block hidden'>تسجيل الخروج</span>
                    <span>
