  ...
  return (
    <div className="supplier flex flex-row min-w-full w-fit bg-white">
      <div className="details flex-1 grid grid-cols-[50px_repeat(auto-fit,_minmax(120px,_1fr))] text-app-gray mr-4 py-6 md:py-10 min-w-[700px]">
        ...
        <h3 className="supplier-name text-primary font-bold ">محمد</h3>
      ...
      <div
        className="actions-list relative flex flex-col justify-center items-center w-[50px]"
        ref={dropRef}
      >
        ...
        <div
          className={`
                        ${isOpenActionsList ? "flex" : "hidden"}
                        actions absolute text-sm text-app-gray py-2 flex-col w-max rounded-md bg-white top-8 left-8 shadow-lg shadow-primary/30 border border-primary/5`}
        >
          <Link
            href="#"
          ...
          >
            ...
            <span className="block">تعديل بيانات العميل</span>
          </Link>
          <Link
            href={`/clients`}
            className="flex flex-row justify-center items-center gap-2 px-4 py-1 hover:bg-app-light-gray"
          >
            ...
            <span className="block">حذف العميل</span>
          </Link>
        </div>
      </div>
    </div>
