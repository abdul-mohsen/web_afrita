    ...
    return (
        <div className="relative">
            ...
            {suggestions.length > 0 && (
                <div className="absolute z-10 bg-white border border-gray-300 rounded-lg mt-1 w-full max-h-60 overflow-y-auto" style={{ bottom: '100%' }}>
                    {suggestions.map((suggestion) => (
                        <div key={suggestion} onClick={() => onSuggestionSelected(null, { suggestion })}>
