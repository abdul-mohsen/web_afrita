...
const ProductItem = ({
  ...
  return (
    <>
      <div className=" product-row flex flex-col min-w-full w-fit bg-white">
        ...
        >
          ...
          >
            ...
            <h3 className="item-name text-primary font-bold">
              {product_named}
            </h3>
          ...
          <div
            className="actions-list relative flex flex-col justify-center items-center gap-2 md:gap-4 w-[50px]"
            ref={dropRef}
          >
      ...
      {isAddQuantity && (
        <AddQuantityForm productName={product_named} openForm={openQtyForm} />
      )}
    </>
  );
};
